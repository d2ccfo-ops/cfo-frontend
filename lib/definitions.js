...
const DEFINITIONS = {
  ...
  "chart-margin-trend": {
    ...
    caveat:
      "Needs a stored daily margin series. Margin is computed on demand for one period at a time today, so there is no history to plot — this turns on once nightly metric snapshots are written.",
  },
  "chart-cash-forecast": {
